          ...
          {activeTab === 'data-pribadi' && (
            <div>
              ...
              <Row>
                ...
                <Col md={4}>
                  <Form.Control type="tel" placeholder="Masukkan nomor hp" style={{ borderColor: "#DEA435" }} />
                </Col>
              </Row>
              <div className="mt-3">
                <Button variant="warning" className="cancel btn">Cancel</Button>
                <Button variant="warning" className="pesansekarang btn">Pesan Sekarang</Button>
              </div>
            </div>
          )}
        </Card.Body>
